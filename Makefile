CONTAINER_URL = naamio/arvostelu:0.2
...
build-release: clean
	docker run -v $$(pwd):/tmp/arvostelu -w /tmp/arvostelu -it ibmcom/swift-ubuntu:4.0 swift build -c release -Xcc -fblocks -Xlinker -L/usr/local/lib
